...
qc.ry(input_params[2], 2)
qc.ry(input_params[3], 3)
qc.cx(0, 2)
qc.cx(1, 3)
qc.barrier()
...
qc.ry(weight_params[3], 3)
qc.rz(weight_params[4], 0)
qc.rz(weight_params[5], 1)
qc.rz(weight_params[6], 2)
qc.rz(weight_params[7], 3)
...
plt.savefig("DEMOS/IRIS/plots/iris_condensed_circuit.png", dpi=150, bbox_inches='tight')
plt.close()
