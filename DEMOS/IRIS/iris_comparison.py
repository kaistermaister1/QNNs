...
# ============================================================================
def run_model_1(sampler, estimator):
    ...
    return model1_accuracies, '1. VQC ZZ+RA 4F\n(3-Class)'

# ============================================================================
# MODEL 2: VQC with ZZFeatureMap + EfficientSU2 (2 features)
# ============================================================================
def run_model_2(sampler, estimator):
    ...
    return model2_accuracies, '2. VQC ZZ+ESU2 2F\n(3-Class)'

# ============================================================================
# MODEL 3: Siamese-like QNN (4-feature pairs)
# ============================================================================
def run_model_3(sampler, estimator):
    ...
    return model3_accuracies, '3. Siamese 4F\n(Binary Pair)'

# ============================================================================
# MODEL 4: Siamese-like QNN (2-feature pairs)
# ============================================================================
def run_model_4(sampler, estimator):
    ...
    return model4_accuracies, '4. Siamese 2F\n(Binary Pair)'


# ============================================================================
# MODEL 5: VQC with Custom Feature Map + Custom Ansatz (4 features)
# ============================================================================
def run_model_5(sampler, estimator):
    ...
    return model5_accuracies, '5. VQC Custom 4F\n(3-Class)'

# ============================================================================
# MODEL 6: VQC with custom feature map and ansatz (2 features)
# ============================================================================
def run_model_6(sampler, estimator):
    ...
    return model6_accuracies, '6. VQC Custom 2F\n(3-Class)'

# ============================================================================
# MODEL 7: 2-Qubit Siamese-like QNN (2-feature pairs, condensed)
# ============================================================================
def run_model_7(sampler, estimator):
    ...
    return model7_accuracies, '7. 2Q Siamese 2F\n(Binary Pair)'
...
def main():
    ...
    if args.model:
        ...
        print(f"📊 Running all {len(model_runners)} models, with {NUM_TRIALS} trials per model")
    print("=" * 60)
    ...
    model_runners = [
        run_model_1, run_model_2, run_model_3, run_model_4,
        run_model_5, run_model_6, run_model_7
    ]

    if args.model:
        # Run a single specified model
        accuracies, model_name = model_runners[args.model - 1](sampler, estimator)
        ...
        for runner in model_runners:
            accuracies, model_name = runner(sampler, estimator)
